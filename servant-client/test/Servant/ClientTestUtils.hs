...
-- | MultiVerb endpoint with WithHeaders for testing duplicate header extraction (SetCookie)
type MultiVerbSetCookieHeaders = '[Header "Set-Cookie" String, Header "Set-Cookie" String]
...
type MultiVerbSetCookie =
  "multiverb-set-cookie"
    :> MultiVerb
         'GET
         '[JSON]
         '[WithHeaders MultiVerbSetCookieHeaders (Bool, (String, String)) (Respond 200 "OK" Bool)]
         (Bool, (String, String))
